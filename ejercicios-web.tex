...
\begin{itemize}
\item \url{https://docs.djangoproject.com/en/4.2/ref/csrf/}
\item \url{https://docs.djangoproject.com/en/4.2/howto/csrf/#using-csrf}
\end{itemize}
...
\textbf{Repositorio plantilla (para entrega):} \\
\url{https://gitlab.etsit.urjc.es/cursosweb/2022-2023/django-users}
...
\textbf{Repositorio plantilla (para entrega):} \\
\url{https://gitlab.etsit.urjc.es/cursosweb/2022-2023/django-tests-gitlab}
