...
Realiza una especificación del framework, y luego una implementación de esa especificación.

Utiliza la implementación para construir (primero, escribiendo su especificación) dos aplicaciones diferentes.

Procura construir el framework de forma que las dos aplicaciones se puedan escribir con la mínima cantidad de código posible.
