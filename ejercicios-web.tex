...
\begin{itemize}
  ...
  \item Se añadirá el caso de que si el \emph{input} para el alias está vacío, se deberá acortar mediante un número aleatorio entre 0 y 1000.
  ...
  \verb|url=https://gsyc.urjc.es&alias=|

  Y se eligirá para acortar un número aleatorio, calculado en la vista, por lo que la URL acortada sería \texttt{https://localhost:1234/762}, si 762 ha sido el número aleatorio generado.

  Seguidamente si se quiere acortar \texttt{http://www.urjc.es} con el nombre de recurso vacío de nuevo, se calculará otro número aleatorio para acortar.

  Así sucesivamente, siempre y cuando el formulario para el nombre de recurso este vacío.

  Hay que tener en cuenta que al calcular el número aleatorio puede dar la coincidencia de repetirse con un alias ya utilizado, por lo que hay que manejar esa situación como en la Mini P1, actualizando el la URL para ese alias.

  \item Se añadirá un recurso \textbf{``/listrandom''} que solo admitirá peticiones GET. Esta vista deberá devolver la lista de URLs que han sido acortadas mediante un número aleatorio. 

  \item Tendrá que almacenar la información relativa a las URLs que acorta en una base de datos, de forma que aunque la aplicación sea rearrancada, las URLs acortadas sigan funcionando adecuadamente. Pueden guardarse tantas tablas y columnas como se considere necesario. (Pista: se puede guardar en una columna de la tabla de URLs un campo booleano que determine si se ha acortado de manera aleatoria o con un alias).
...
El programa \texttt{servidor.py} es la versión más simple, mientras que \texttt{servidor2.py} es una versión un poco más completa, que usa enlaces de la forma \texttt{/objetos/\{id\}} para acceder a los objetos, y tiene un formulario para añadir objetos solo en las páginas de los objetos.

Carpeta de código: \texttt{Python-Web/servidor-carrito}
...
Carpeta de código: \texttt{Python-Web/servidor-cookies}
...
Vamos a diseñar una aplicación HTTP que mantiene una lista de la compra. Cada elemento de la lista tendrá un nombre (por ejemplo, "leche") y una cantidad (por ejemplo 5). La aplicación me permitirá ver los elementos de la lista y la cantidad de cada elemento. También me permitirá incluir nuevos elementos en la lista, darles una cantidad, y cambiar la cantidad de un elemento que ya tenía en la lista.
...
Carpeta de código: \texttt{Python-Web/compra}
...
Carpeta de código: \texttt{Python-Web/mvc}
...
Repositorio de inicio: \url{https://gitlab.eif.urjc.es/cursosweb/2024-2025/videos-canal-youtube}.
...
Repositorio de entrega en GitLab: \\
\url{https://gitlab.eif.urjc.es/cursosweb/django-cms-bootstrap}
...
\textbf{Repositorio plantilla (para entrega):} \\
\url{https://gitlab.eif.urjc.es/cursosweb/2024-2025/django-users}
...
\textbf{Repositorio plantilla (para entrega):} \\
\url{https://gitlab.eif.urjc.es/cursosweb/2024-2025/django-tests-gitlab}
