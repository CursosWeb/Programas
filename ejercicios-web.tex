...
%%-----------------------------------------------------------------------------
%%-----------------------------------------------------------------------------
\subsection{Sitio web para acceder a issues de GitLab}
...
Primero utiliza \texttt{curl} para acceder a los tickets de un proyecto (ojo, todo en una línea):
...
Luego, escribe un script de Python que haga lo mismo, pero mostrando en lugar del documento JSON que te descargas de la API, el listado de tickets, con solo su título.
...
El programa \texttt{issues.py} es una versión simple, hecha con la ayuda de un asistente de IA.
