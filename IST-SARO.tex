...
%%----------------------------------------------------------------
\subsubsection{\martesF: Interoperación web I (1 horas)}
\label{cal:martesF}
...
Los componentes principales de una aplicación Django y su relación con el patrón modelo-vista-controlador.
...
\item \textbf{Ejercicio (discusión en clase:} ``Calculadora simple versión REST (Django)'' (ejercicio~\ref{subsec:calc-simple-rest-django}). \\
