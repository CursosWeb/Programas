...
\begin{itemize}
  ...
  \item Se añadirá el caso de que si el input para el alias está vacío, se deberá acortar mediante un número aleatorio entre 0 y 1000.
  ...
  \item Se añadirá un recurso \textbf{``/listrandom''} que solo admitirá peticiones GET. Está vista deberá devolver la lista de urls que han sido acortadas mediante un número aleatorio. 

  \item Tendrá que almacenar la información relativa a las URLs que acorta en una base de datos, de forma que aunque la aplicación sea rearrancada, las URLs acortadas sigan funcionando adecuadamente. Pueden guardarse tantas tablas y columnas como se considere necesario. (pista: se puede guardar en una columna de la tabla de urls un campo booleano que determine si se acortado de manera aleatoria o con un alias).
