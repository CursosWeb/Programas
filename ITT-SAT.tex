...
\newcommand{\martesA}{23 de enero}
\newcommand{\martesB}{30 de enero}
\newcommand{\martesC}{6 de febrero}
\newcommand{\martesD}{13 de febrero}
\newcommand{\martesE}{20 de febrero}
\newcommand{\martesF}{27 de febrero}
\newcommand{\martesG}{5 de marzo}
\newcommand{\martesH}{12 de marzo}
\newcommand{\martesI}{19 de marzo}
\newcommand{\martesJ}{2 de abril}
\newcommand{\martesK}{9 de abril}
\newcommand{\martesL}{16 de abril}
\newcommand{\martesM}{23 de abril}
...
\begin{tabular}{|l|l|}
  ...
  \nameref{cal:martesN} & Festivo               \\ \hline
...
%%----------------------------------------------------------------
\subsubsection{\martesG: Conceptos básicos VI (1 horas)}
\label{cal:martesG}
...
%%----------------------------------------------------------------
\subsubsection{\martesG: Interoperación web I (1 horas)}
...
%%----------------------------------------------------------------
\subsubsection{\martesJ: MVC II (1 hora)}
\label{cal:martesJ}
...
%%----------------------------------------------------------------
\subsubsection{\martesJ: XML (1 hora)}
...
%%----------------------------------------------------------------
\subsubsection{\martesM: Clase final (2 horas)}
\label{cal:martesM}
...
\item \textbf{Presentación:} Práctica final, enunciado (apartado~\ref{practica-final-2023-05}).
...
\item \textbf{Presentación:} Práctica final, implementación (apartado~\ref{practica-final-2023-05}).
\end{itemize}
