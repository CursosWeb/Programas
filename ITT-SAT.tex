...
\author{Gregorio Robles Martínez, Alberto Rodríguez, \\
  Sergio Montes \\
...
% \newcommand{\martesN}{30 de abril}
% \newcommand{\martesO}{7 de mayo}

%\newcommand{\juevesAa}{23 de enero}
\newcommand{\juevesA}{29 de enero}
\newcommand{\juevesB}{5 de febrero}
\newcommand{\juevesC}{12 de febrero}
\newcommand{\juevesD}{19 de febrero}
\newcommand{\juevesE}{26 de febrero}
\newcommand{\juevesF}{5 de marzo}
\newcommand{\juevesG}{12 de marzo}
\newcommand{\juevesH}{19 de marzo}
\newcommand{\juevesI}{26 de marzo}
\newcommand{\juevesJ}{9 de abril}
\newcommand{\juevesK}{16 de abril}
\newcommand{\juevesL}{23 de abril}
\newcommand{\juevesM}{30 de abril}
\newcommand{\juevesN}{7 de mayo}
...
\begin{itemize}
\item \textbf{Frikiminutos}: ``OpenClaw''.
...
\begin{itemize}
\item \textbf{Frikiminutos}: ``Másters en el EEES''.
...
\begin{itemize}
  \item \textbf{Frikiminutos}: ``WebAssembly''.

  \item \textbf{Ejercicio (discusión en clase):} ``Transplante de cookies" (ejercicio~\ref{subsec:transplante-cookies})  

  \item \textbf{Presentación:} Cookies
  \item \textbf{Material:} Transparencias, tema ``Cookies''
%  \item \textbf{Discusión de ejercicio:} ``Cookies en tu navegador'' (ejercicio~\ref{subsec:cookies-navegador})  
  ...
  \item \textbf{Ejercicio (discusión en clase):} ``Trackers en páginas web'' (ejercicio~\ref{subsec:trackers-paginas-web})
  \item \textbf{Ejercicio (discusión en clase):} ``Trackers en páginas web (Ghostery)'' (ejercicio~\ref{subsec:trackers-paginas-web-2})
  \item Discusión sobre la relación de traza de historias de navegación con identidades personales.
...
%%----------------------------------------------------------------
%\subsubsection{\martesE: Conceptos básicos V (2 horas)}
%
%\begin{itemize}
...
%%----------------------------------------------------------------
\subsubsection{\martesF: Interoperación web (2 horas)}
\label{cal:martesF}
...
\item \textbf{Discusión:} Introducción a las operaciones idempotentes.\item \textbf{Ejercicio (discusión en clase)}: ``Listado de lo que tengo en la nevera'' (ejercicio~\ref{subsec:contenido-nevera}).
\item \textbf{Ejercicio propuesto (entrega en el foro):} ``Sistema de transferencias bancarias'' (ejercicio~\ref{subsec:transferencias-bancarias}). \\
  Entrega recomendada: antes del \martesG.
\end{itemize}

%%----------------------------------------------------------------
\subsubsection{\martesG: Interoperación web II (1 hora)}
%\label{cal:martesG}
...
\item \textbf{Ejercicio (discusión en clase):} ``Ejercicio 1 Examen Convocatoria Extraordinaria Curso 2022/2023'' (examen~\ref{exa-2023-06}).
...
%%----------------------------------------------------------------
\subsubsection{\martesG: MVC (1 hora)}
\label{cal:martesG}
...
\item \textbf{Presentación:} ``Componentes de aplicaciones Django y MVC''.
  Componentes principales de una aplicación Django y su relación con el patrón modelo-vista-controlador.

\end{itemize}

%%----------------------------------------------------------------
\subsubsection{\martesH: MVC II (2 horas)}
\label{cal:martesH}
...
%%----------------------------------------------------------------
\subsubsection{\martesI: XML (2 horas)}
\label{cal:martesI}
...
%%----------------------------------------------------------------
\subsubsection{\martesJ: JSON (2 horas)}
\label{cal:martesJ}
...
\item \textbf{Ejercicio (entrega en GitLab):} ``Django cms\_css basico'' (ejercicio~\ref{subsec:django-cms-css-basico}). \\
  Entrega recomendada: antes del \ref{cal:martesL}.
\end{itemize}
...
\item \textbf{Ejercicio (entrega en GitLab):} ``Django cms\_bootstrap componentes personalizados'' (ejercicio~\ref{subsec:django-cms-bootstrap-3})
  Entrega recomendada: antes del \martesM.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Ejercicio (entrega en GitLab):} Por determninar \\
  Entrega recomendada: antes del \martesN.
\end{itemize}


%%----------------------------------------------------------------
\subsubsection{\martesN: Detalles finales (2 horas)}
\label{cal:martesN}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesA: Entorno I  (2 horas)}
\label{cal:juevesA}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: Entorno II  (2 horas)}
\label{cal:juevesB}
...
\url{https://gitlab.eif.urjc.es/cursosweb/2025-2026/cabeceras}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesN: Detalles finales  (2 horas)}
\label{cal:juevesN}
