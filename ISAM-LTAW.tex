...
\item \textbf{Ejercicios (discusión en clase)}: ``Interacción con un LLM (con especificación)''  (ejercicio~\ref{subsec:django-llm}).
...
\begin{itemize}
\item \textbf{Discusión en clase}: Autenticación vía OAuth
\item \textbf{Discusión en clase}: Despliegue
\item \textbf{Ejercicios (discusión en clase)}: ``Autenticación con OAuth (con especificación)'' (ejercicio~\label{subsec:django-oauth}).
