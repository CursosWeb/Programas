...
\newcommand{\lunesJ}{13 de abril}
\newcommand{\lunesK}{20 de abril}
\newcommand{\lunesL}{27 de abril}
\newcommand{\lunesM}{4 de mayo}
...
%%----------------------------------------------------------------
\subsubsection{\lunesJ: XML (2 horas)}
\label{cal:lunesJ}
...
%%----------------------------------------------------------------
\subsubsection{\lunesM: Bootstrap (2 horas)}
\label{cal:lunesM}
...
%%----------------------------------------------------------------
% \subsubsection{\lunesN: Detalles finales (2 horas)}
% \label{cal:lunesN}

% Htmx. Repaso, ejemplo de examen.

% %%----------------------------------------------------------------
% \subsubsection{\lunesO: Clase final (2)}
% \label{cal:martesO}
...
\subsubsection{Aplicaciones web (2 horas)}
%\label{cal:martesD}
...
\subsubsection{Servidores con clase (2 horas)}
%\label{cal:martesE}
...
%%%----------------------------------------------------------------------------
\subsubsection{\martesJ: Django II (2 horas)}
\label{cal:martesJ}

\begin{itemize}
\item \textbf{Presentación:} Primeros ejercicios con base de datos.
\item \textbf{Ejercicio (discusión en clase):} ``Django cms no persistente'' (ejercicio~Python-Django/django-cms-nopersistente-spec).
\item \textbf{Ejercicio (entrega en GitLab):} ``Django cms persistente'' (ejercicio~\ref{subsec:django-cms-persistente}) \\
  Entrega recomendada: antes del \martesK
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Presentación:} Práctica final, enunciado (apartado~\ref{practica-final-2026-05-ltaw}).
...
\item \textbf{Presentación:} Práctica final, implementación (apartado~\ref{practica-final-2026-05-ltaw}).
\end{itemize}



%%----------------------------------------------------------------------------
\subsubsection{\martesN: Repaso (2 horas)}
\label{cal:martesN}
...
%%----------------------------------------------------------------
% \subsubsection{\martesN: Detalles finales II (2 horas)}
% \label{cal:martesN}
