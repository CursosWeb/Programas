...
%%----------------------------------------------------------------
\subsubsection{\lunesC: Conceptos básicos II (2 horas)}
\label{cal:lunesC}

Cómo realizar sesiones en HTTP. Profundización en el concepto de sesión, y técnicas para conseguirla, incluyendo cookies y otros mecanismos.
...
%%----------------------------------------------------------------
\subsubsection{\lunesD: Conceptos básicos III (2 horas)}
\label{cal:lunesD}
