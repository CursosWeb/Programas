...
\item \textbf{Ejercicios (discusión en clase)}: ``Autenticación con OAuth (con especificación)'' (ejercicio~\ref{subsec:django-oauth}).
\item \textbf{Ejercicios (discusión en clase)}: ``Gestor de contenidos con videos de YouTube (despliegue)'' (ejercicio~\ref{subsec:django-cms-youtube-despliegue}).
\end{itemize}
