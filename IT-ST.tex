...
%%----------------------------------------------------------------------------
\subsubsection{\juevesA: Python y entorno de desarrollo I}
\label{cal:juevesAb}
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: Python y entorno de desarrollo II}
\label{cal:juevesB}
...
\item \textbf{Ejercicio (realizado en clase):} ``Subida de programa a repo de GitLab'' (ejercicio~\ref{subsec:practicas-programa-gitlab}) \\
...
%%----------------------------------------------------------------------------
\subsubsection{\juevesB: Python II (1 hora)}
\label{cal:juevesBb}

\begin{itemize}
\item \textbf{Presentación:} ``Introducción a Python'' (listas, bucles (for), ficheros, strings, argumentos)
\item \textbf{Material:} Transparencias ``Introducción a Python''
...
\begin{itemize}
\item \textbf{Frikiminutos Python:} ``Despliegue de páginas web en GitHub/GitLab''.
\item \textbf{Ejercicio (hecho en clase):} Uso de ficheros (ejercicio~\ref{subsec:ficheros-listas}). (Ligeramente modificado para que escriba en fichero tambien)
\item \textbf{Presentación:} ``Introducción a Python''. Clases y orientación a objetos en Python.
\item \textbf{Material:} Transparencias ``Introducción a Python''
\item \textbf{Ejercicio propuesto (entrega en GitLab):} ``Descarga de documentos web con módulos'' (ejercicio~\ref{subsec:eje-python-descarga-web-modulos}).  Entrega recomendada: antes del \juevesD. 
