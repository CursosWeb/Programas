...
\author{Alberto Rafael Rodríguez Iglesias \\
...
%%-----------------------------------------------------------------------
\subsubsection{\lunesAa: Presentación  (2 horas)}
\label{cal:lunesAa}
...
%\item \textbf{Material:} Transparencias ``Introducción a Python''
\item \textbf{Presentación:} ``Repaso de git''
...
\item \textbf{Material:} Transparencias ``Introducción a Python''
\item \textbf{Presentación (repaso):} Introducción a la entrega de prácticas en GitLab con SSH (seccion~\ref{sec:eje-entrega-practicas-incr}).
...
\begin{itemize}
\item \textbf{Frikiminutos:} ``VR en el navegador''.
...
\begin{itemize}
\item \textbf{Frikiminutos:} ``Gitlab-Github Pages''.
...
\begin{itemize}
  ...
  \item \textbf{Material:} Transparencias ``Introducción a Django''
  \item \textbf{Ejercicio (entrega en GitLab):} ``Django cms\_users'' (ejercicio~\ref{subsec:django-users-put}). \\
...
% %%----------------------------------------------------------------------------
 ...
 \begin{itemize}
   ...
   \item \textbf{Discusión:} Dudas Práctica final (apartado~\ref{practica-final-2026-05})
\end{itemize}
