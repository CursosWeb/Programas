...
Para esta parte, será necesario instalar también el módulo de OpenAI con pip (paquete \verb|openai|), por ejemplo incluyéndolo en \verb|requirements.txt|.

Ejemplo mínimo de uso de la API:
...
\item ¿Hay que instalar alguna librería adicional para usar la API propuesta?
  ...
  Sí. Debes instalar el módulo de OpenAI para Python (paquete \verb|openai|), por ejemplo con \verb|pip install openai| y reflejarlo en \verb|requirements.txt|.
\end{itemize}
